...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void initBottomNavView(){
        mBottomNavView = findViewById(R.id.bottom_nav_main);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    case R.id.action_nav_home:
                        replaceFragment(mHomeFragment,"Home");
                        break;
                    case R.id.action_nav_my_task:
                        replaceFragment(mMyTaskFragment,"My Task");
                        break;
                    case R.id.action_nav_chat:
                        replaceFragment(mChatFragment,"Chat");
                        break;
                    case R.id.action_nav_alert:
                        replaceFragment(mAlertFragment,"Alert");
                        break;
                }
                return true;
            }
